...
class CiaSpider(scrapy.Spider):
    ...
    custom_settings = {'FEED_URI': 'save.json', 'FEED_FORMAT': 'json', 'FEED_EXPORT_ENCODING': 'utf-8'}

    def parse(self, response):
        article_links = response.xpath('//a[starts-with(@href, "collection") and (parent::h2|parent::h3)]/@href').getall()
    ...
    def parse_article(self, response, **kwargs):
        ...
        yield {'link': link, 'title': title, 'body': body}
